...
using GoogleApiService.Entities.Maps.Roads.SpeedLimits.Request.Enums;
using GoogleApiService.Helpers;

namespace GoogleApiService.Entities.Maps.Roads.SpeedLimits.Request
{
    /// <summary>
    /// SpeedLimits Request.
    /// </summary>
    public class SpeedLimitsRequest : BaseMapsRequest, IQueryStringRequest
	{
        ...
        /// </summary>
        protected internal override string BaseUrl => "roads.googleapis.com/v1/speedLimits/json";
